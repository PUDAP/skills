---
name: puda
description: Skills and capabilities for working on the PUDA platform
---
...
- [get-machine-state](references/get-machine-state.md) - Retrieve machine state from NATS Key-Value store. Run with the machine_id of the machine you want to get the state for.
