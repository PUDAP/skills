...
| **puda-machine-vision-validation** | Environment- and machine-neutral visual safety gate for BEARS, IMRE, NTU, and future PUDA sites. Selects the active environment and machine profile, captures fresh evidence, and blocks uncertain physical execution. |
